...
corregido <- stringr::str_replace_all(corregido, "gv", "gu")
...
corregido <- stringr::str_replace_all(corregido, "\\bome\\b", "ombre")
corregido <- stringr::str_replace_all(corregido, "\\bomes\\b", "ombres")
